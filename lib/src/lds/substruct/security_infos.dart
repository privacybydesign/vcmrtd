  ...
  void _dispatch(ASN1Sequence seq) {
    ...
    try {
      ...
      if (_isChipAuthenticationPublicKeyInfo(oid)) {
        chipAuthenticationPublicKeyInfos.add(
          _parseChipAuthenticationPublicKeyInfo(oid, seq),
        );
        return;
      }
      if (_isTerminalAuthenticationInfo(oid)) {
        terminalAuthenticationInfos.add(
          _parseTerminalAuthenticationInfo(oid, seq),
        );
        return;
      }
      if (_isEfDirInfo(oid)) {
