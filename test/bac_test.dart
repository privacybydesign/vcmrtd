...
void main() {
  test('BAC key seed test', () {
    ...
    ); // Note: Composite CD changed from 1 to 2
    expect(
      DBAKey.fromMRZ(mrz).keySeed,
      "239AB9CB282DAF66231DC5A4DF6BFBAE".parseHex(),
    );
  ...
  test('BAC session establishment test', () {
    ...
    expect(
      BAC.generateS(RNDicc: tvRNDicc, RNDifd: tvRNDifd, Kifd: tvKifd),
      tvS,
    );
    ...
    expect(
      BAC.calculateSCC(RNDifd: tvRNDifd, RNDicc: tvRNDicc).toBytes(),
      tvSCC,
    );
  });
}
