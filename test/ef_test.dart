  ...
  test('Test parsing/encoding EF.DG1', () {
    ...
    final tvDG1TD1 =
        "615D5F1F5A493C4E4C44584938353933354638363939393939393939303C3C3C3C3C3C3732303831343846313130383236384E4C443C3C3C3C3C3C3C3C3C3C3C3856414E3C4445523C535445454E3C3C4D415249414E4E453C4C4F55495345"
            .parseHex();
    var dg1 = EfDG1.fromBytes(tvDG1TD1, DocumentType.passport);
    expect(dg1.toBytes(), tvDG1TD1);
    expect(dg1.passportData?.mrz.version, MRZVersion.td1);
    expect(dg1.passportData?.mrz.documentCode, 'I');
    expect(dg1.passportData?.mrz.documentNumber, 'XI85935F8');
    expect(dg1.passportData?.mrz.country, 'NLD');
    expect(dg1.passportData?.mrz.nationality, 'NLD');
    expect(dg1.passportData?.mrz.firstName, 'MARIANNE LOUISE');
    expect(dg1.passportData?.mrz.lastName, 'VAN DER STEEN');
    expect(dg1.passportData?.mrz.gender, 'F');
    expect(dg1.passportData?.mrz.dateOfBirth, DateTime(1972, 8, 14));
    expect(dg1.passportData?.mrz.dateOfExpiry, DateTime(2011, 8, 26));
    expect(dg1.passportData?.mrz.optionalData, '999999990');
    expect(dg1.passportData?.mrz.optionalData2, '');
    ...
    final tvDG1TD2 =
        "614B5F1F48493C415441534D4954483C3C4A4F484E3C543C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3132333435363738393C484D44373430363232314D31303132333132303132323C3C3C30"
            .parseHex();
    dg1 = EfDG1.fromBytes(tvDG1TD2, DocumentType.passport);
    expect(dg1.toBytes(), tvDG1TD2);
    expect(dg1.passportData?.mrz.version, MRZVersion.td2);
    expect(dg1.passportData?.mrz.documentCode, 'I');
    expect(dg1.passportData?.mrz.documentNumber, '123456789012');
    expect(dg1.passportData?.mrz.country, 'ATA');
    expect(dg1.passportData?.mrz.nationality, 'HMD');
    expect(dg1.passportData?.mrz.firstName, 'JOHN T');
    expect(dg1.passportData?.mrz.lastName, 'SMITH');
    expect(dg1.passportData?.mrz.gender, 'M');
    expect(dg1.passportData?.mrz.dateOfBirth, DateTime(1974, 6, 22));
    expect(dg1.passportData?.mrz.dateOfExpiry, DateTime(2010, 12, 31));
    expect(dg1.passportData?.mrz.optionalData, '');
    ...
    expect(dg1.passportData?.mrz.documentNumber, 'L898902C3');
    expect(dg1.passportData?.mrz.country, 'UTO');
    expect(dg1.passportData?.mrz.nationality, 'UTO');
    expect(dg1.passportData?.mrz.firstName, 'ANNA MARIA');
    expect(dg1.passportData?.mrz.lastName, 'ERIKSSON');
    expect(dg1.passportData?.mrz.gender, 'F');
    expect(dg1.passportData?.mrz.dateOfBirth, DateTime(1974, 8, 12));
    expect(dg1.passportData?.mrz.dateOfExpiry, DateTime(2012, 4, 15));
    expect(dg1.passportData?.mrz.optionalData, 'ZE184226B');
    expect(dg1.passportData?.mrz.optionalData2, null);
    ...
    expect(dg1.passportData?.mrz.version, MRZVersion.td3);
    expect(dg1.passportData?.mrz.documentCode, 'P');
    expect(dg1.passportData?.mrz.documentNumber, 'C11T002JM');
    expect(dg1.passportData?.mrz.country, 'D');
    expect(dg1.passportData?.mrz.nationality, 'D');
    expect(dg1.passportData?.mrz.firstName, 'ERIKA');
    expect(dg1.passportData?.mrz.lastName, 'MUSTERMANN');
    expect(dg1.passportData?.mrz.gender, 'F');
    expect(dg1.passportData?.mrz.dateOfBirth, DateTime(1996, 8, 12));
    expect(dg1.passportData?.mrz.dateOfExpiry, DateTime(2023, 10, 31));
    expect(dg1.passportData?.mrz.optionalData, '');
    expect(dg1.passportData?.mrz.optionalData2, null);
