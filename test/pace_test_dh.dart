...
void main() {
  test('PACE session establishment test(with DBA) - DH', () {
    ...
    Uint8List terminalPrivateKey = '5265030F751F4AD18B08AC565FC7AC952E41618D'
        .parseHex();
    ...
    Uint8List chipPrivateKey = '66DDAFEAC1609CB5B963BB0CB3FF8B3E047F336C'
        .parseHex();
    ...
    final initializePaceMsgTerminal = "0022C1A40F800A04007F00070202040102830101"
        .parseHex();
    ...
    final efCardAccessData = "31143012060A04007F00070202040102020102020100"
        .parseHex();
    ...
    //
    BigInt calcSharedSecretChip = chip.getSharedSecret(
      otherPubKey: terminal.getPubKey().toBytes(),
    );
    BigInt calcSharedSecretTerminal = terminal.getSharedSecret(
    ...
    expect(
      Utils.bigIntToUint8List(bigInt: calcEphemeralSharedSecretChip),
    ...
    expect(
      calcInputDataTTerminal.sublist(0, 147),
