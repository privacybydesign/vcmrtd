...
// Re-export result types so that callers only need to import this file via the package barrel.
export 'package:vcmrtd/face_verification.dart' show WorkerMatchResult, WorkerFrameResult;
...
class FaceVerificationWorker {
  ...
  Future<void> initialize() async {
    ...
    const assets = <String>[
      'packages/vcmrtd/lib/src/face_verification/Models/face_detector.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/face_landmarks_detector.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/face_blendshapes.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/minifasnet_v1se.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/minifasnet_v2.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/bigsmall_1.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/bigsmall_2.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/bigsmall_3.tflite',
      'packages/vcmrtd/lib/src/face_verification/Models/GhostFaceNet_fp32_V2.tflite',
    ];
