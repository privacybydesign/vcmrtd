...
class OnDeviceFaceVerificationScreen extends StatefulWidget {
  ...
  const OnDeviceFaceVerificationScreen({
    super.key,
  ...
  const OnDeviceFaceVerificationScreen.withEngine({
    super.key,
  ...
  @override
  State<OnDeviceFaceVerificationScreen> createState() => OnDeviceFaceVerificationScreenState();
}

// ── State ──────────────────────────────────────────────────────────────────

class OnDeviceFaceVerificationScreenState extends State<OnDeviceFaceVerificationScreen> with WidgetsBindingObserver {
