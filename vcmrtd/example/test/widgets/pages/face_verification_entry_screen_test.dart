...
void main() {
  ...
  testWidgets('renders the face verification screen', (tester) async {
  ...
  testWidgets('forwards args to the screen', (tester) async {
    final args = FaceVerificationArgs(portraitImageBytes: Uint8List.fromList(<int>[1, 2, 3]));
    await tester.pumpWidget(
