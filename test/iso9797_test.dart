  ...
  test('ISO9797 MAC algorithm 3', () {
    ...
    final tvEifd =
        "72C29C2371CC9BDB65B779B8E8D37B29ECC154AA56A8799FAE2F498F76ED92F2"
            .parseHex();
    expect(
      ISO9797.macAlg3(tvKmac, tvEifd),
      "5F1448EEA8AD90A7".parseHex(),
    ); // function should pad the msg
    ...
    var tvN = "887022120C06C2270CA4020C800000008709016375432908C044F6"
        .parseHex();
    expect(
      ISO9797.macAlg3(tvKmac, tvN),
      "BF8B92D635FF24F8".parseHex(),
    ); // function should pad the msg

    // Test vectors from ICAO 9303 p11 - Appendix D to Part 11, section D.4.1
    var tvK = "887022120C06C22899029000".parseHex();
    expect(
      ISO9797.macAlg3(tvKmac, tvK),
      "FA855A5D4C50A8ED".parseHex(),
    ); // function should pad the msg
