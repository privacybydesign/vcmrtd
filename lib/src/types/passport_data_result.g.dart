...
RawDocumentData _$PassportDataResultFromJson(Map<String, dynamic> json) =>
    RawDocumentData(
      ...
      aaSignature: const Uint8ListConverter().fromJson(
        json['aa_signature'] as String?,
      ),
    );

Map<String, dynamic> _$PassportDataResultToJson(RawDocumentData instance) =>
    <String, dynamic>{
